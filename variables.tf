variable "applications" {
  description = "Map of applications to create with their app roles"
  type = map(object({
    display_name = string # Display name for the application
  ...
  default = {
    "transactions" = {
      display_name = "TaxtTransactionsApp"
      app_roles = [
        {
          display_name         = "Transactions.Read"
          description          = "Allows read access to transaction resources"
          value                = "Transactions.Read"
          allowed_member_types = ["User", "Application"]
        },
        {
          display_name         = "Transactions.Write"
          description          = "Allows write access to transaction resources"
    ...
    "documents" = {
      display_name = "TaxtDocumentsApp"
      app_roles = [
        {
          display_name         = "Documents.Read"
          description          = "Allows read access to document resources"
          value                = "Documents.Read"
          allowed_member_types = ["User", "Application"]
        },
        {
          display_name         = "Documents.Write"
          description          = "Allows write access to document resources"
